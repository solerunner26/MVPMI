...
if (!development)
  throw new Error(
    "Production launch is disabled until member identity verification and retention policy are completed. Set DEVELOPMENT_MODE=true for a test deployment with synthetic data only.",
  );
const { app } = createApp({
